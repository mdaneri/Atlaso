...
still loading, only the latest selection can update the dialog, report history,
download link, or error status; slower responses for older selections are
ignored. The selected report covers all available system, firmware,
