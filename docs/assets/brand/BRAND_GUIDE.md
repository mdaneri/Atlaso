...
- Use monochrome variants for engraving, one-color printing, terminal documentation, and constrained UI.
- Preserve clear space around the mark equal to the width of the “A” stem.
...
- Favicon ICO and small PNG icons
