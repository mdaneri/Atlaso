---
title: What is Atlaso?
description: Discover the Esperanto word, the map, and the myth behind the Atlaso name.
audience:
  - operator
  - contributor
  - maintainer
...
*Atlaso* is the Esperanto word for **atlas**: a collection of maps that brings many places together in one useful
view. The product name is pronounced roughly *ah-TLAH-soh* and capitalized as **Atlaso**.

## A map for the lab

An atlas does more than show one destination. It organizes many landscapes, adds context, and helps people find a path
...
- Read about [Atlaso in Greek mythology on the Esperanto Wikipedia](https://eo.wikipedia.org/wiki/Atlaso_(mitologio)).
- Hear the pronunciation and see the Esperanto meanings of
  [*atlaso* in Wiktionary](https://en.wiktionary.org/wiki/atlaso).
