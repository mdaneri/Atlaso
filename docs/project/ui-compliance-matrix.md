...
| `/ui/management/appliance-update` — streams, repositories, modules, tasks | Wizard-backed Tabulator plus non-grid settings; ESX Storage, Automation, and DNS references | Repository/module details, validation, source data, and shared Tasks fallback remain readable | Admin write controls; shared confirmation for deletion; maintenance task boundary remains separate from global apply | Pass D/N/K/F/Z/V | E1–E8 |
