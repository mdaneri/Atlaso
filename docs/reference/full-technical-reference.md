...
helper installs Paramiko plus the pinned 1Password SDK and their dependencies into
a temporary deployment directory; it does not modify the global Python
