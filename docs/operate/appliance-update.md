...
refuses unexpected or manually customized text. After every edit it verifies that the title, tag, target, publication
state, and asset identity remain unchanged:
