...
default `-PackerStartupTimeoutSeconds 900` bounds the interval from **Powering on virtual machine** to SSH provisioning;
`-PackerHeartbeatSeconds 30` controls the heartbeat interval. A timeout terminates only the Packer process tree and
