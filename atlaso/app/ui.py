...
def create_esx_storage_volume_from_ui(
    ...
    row = EsxStorageVolume(
        ...
        mount_path=str(candidate.get("mount_path") or mount_path).strip() or f"/mnt/atlaso-esx-storage/{esx_storage_slug(normalized_name)}",
...
_management_between_managed_ldap_identity_router = router
router = APIRouter(
    prefix=MANAGEMENT_UI_ROOT,
    dependencies=[Depends(require_management_ui_request)],
)
...
_management_after_identity_router = router
...
UI_ROUTER_REGISTRY.register(
    ...
    (RouterContribution(plane="management", router=_management_between_managed_ldap_identity_router),),
)
UI_ROUTER_REGISTRY.register(
    "identity",
...
UI_ROUTER_REGISTRY.register(
    ...
    (RouterContribution(plane="management", router=_management_after_identity_router),),
)
