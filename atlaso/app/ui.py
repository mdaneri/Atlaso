...
from atlaso.app.schemas import ApiTokenCreate, WanPolicyCreate
...
def download_ldap_vcf_bundle(
    ...
    return Response(
        ...
        headers={"Content-Disposition": f'attachment; filename="atlaso-ldap-{organization.slug}-vcf91.zip"'},
    )
