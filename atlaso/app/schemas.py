...
class EsxStorageSettingsUpdate(BaseModel):
    enabled: bool = False
    hostname: str = Field(default="nfs.atlaso.internal", min_length=1, max_length=253)
...
class LdapSettingsUpdate(BaseModel):
    enabled: bool = False
    hostname: str = Field(default="ldap.atlaso.internal", min_length=1, max_length=180)
...
class DnsSettingsUpdate(BaseModel):
    ...
    domain: str = Field(default="atlaso.internal", min_length=1, max_length=500)
    ...
    authoritative_server: str = Field(default="ns1.atlaso.internal", min_length=1, max_length=253)
    authoritative_contact: str = Field(default="hostmaster.atlaso.internal", min_length=1, max_length=253)
...
class DhcpSettingsUpdate(BaseModel):
    ...
    domain_name: str = Field(default="atlaso.internal", min_length=1, max_length=120)
...
class SettingsUpdate(BaseModel):
    appliance_fqdn: str = Field(default="core.atlaso.internal", min_length=1, max_length=180)
    management_https_enabled: bool = False
    web_terminal_enabled: bool = False
    web_terminal_interfaces: list[str] = Field(default_factory=list)
    root_ssh_enabled: bool = False
