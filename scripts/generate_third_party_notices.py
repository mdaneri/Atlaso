#!/usr/bin/env python3
"""Generate a deterministic third-party notice inventory for Atlaso releases."""
...
def generate_notice(*, output: Path, version: str, python_records: dict[str, dict[str, str]], vendored: list[dict[str, str]], rpms: list[dict[str, str]] | None) -> None:
    ...
    lines = [
        ...
        "",
        f"Generated for Atlaso {version}. Do not edit this file manually.",
        "",
        "Atlaso-authored code is licensed under the MIT License. Components below retain their own terms; their package-provided or bundled license texts remain authoritative.",
        "",
    ]
