...
DEPLOYED_FILE_MODES = {
    ...
    "/etc/systemd/system/atlaso-data-disks.service": 0o644,
    "/etc/systemd/system/atlaso-guest-agent-select.service": 0o644,
    "/etc/systemd/system/atlaso-bootstrap-https.service": 0o644,
    "/etc/systemd/system/atlaso-vmware-ovf-customize.service": 0o644,
    "/etc/systemd/system/atlaso-vmware-ovf-prepare.service": 0o644,
    ...
    "/etc/sudoers.d/atlaso-helper": 0o440,
    "/opt-atlaso/bin/atlaso-mount-data-disks": 0o755,
    "/opt-atlaso/bin/atlaso-select-guest-agent": 0o755,
    "/opt-atlaso/bin/atlaso-initialize-machine-identity.py": 0o755,
    "/opt-atlaso/bin/atlaso-bootstrap-https": 0o755,
    "/opt-atlaso/bin/atlaso-vmware-ovf-customize.py": 0o755,
