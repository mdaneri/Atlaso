...
def test_pwa_manifest_service_worker_and_offline_shell(client):
    ...
    assert "atlaso-management-pwa-v263" in service_worker.text
    ...
    assert "/static/appliance-apply-polling.js?v=issue-420-2" in service_worker.text
...
def test_shared_ui_pattern_shell_and_wizard_contracts(client):
    ...
    for shell, app_asset in (
        ...
        (base, "/static/appliance-apply-polling.js?v=issue-420-2"),
    ):
