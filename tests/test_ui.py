...
def test_pwa_manifest_service_worker_and_offline_shell(client):
    ...
    assert "atlaso-pwa-v194" in service_worker.text
    ...
    assert "/static/app.css?v=atlaso-monaco-expand-20260729-2" in service_worker.text
    ...
    assert "/static/app.css?v=atlaso-monaco-expand-20260729-2" in offline.text
...
def test_monitor_page_renders_and_data_endpoint(client):
    ...
    assert "/static/app.css?v=atlaso-monaco-expand-20260729-2" in page.text
