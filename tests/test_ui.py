...
def test_pwa_manifest_service_worker_and_offline_shell(client):
    ...
    assert "atlaso-management-pwa-v244" in service_worker.text
    ...
    assert "/static/appliance-apply-polling.js?v=issue-294-1" in service_worker.text
    assert "/static/ui-routes.js?v=issue-287-1" in service_worker.text
    assert "/static/app.js?v=appliance-apply-terminal-294-1" in service_worker.text
...
def test_shared_ui_pattern_shell_and_wizard_contracts(client):
    ...
    for shell, app_asset in (
        (base, "/static/app.js?v=appliance-apply-terminal-294-1"),
        (public_base, "/static/app.js?v=appliance-apply-terminal-294-1"),
        (base, "/static/appliance-apply-polling.js?v=issue-294-1"),
    ):
...
def test_monitor_page_renders_and_data_endpoint(client):
    ...
    assert "/static/app.js?v=appliance-apply-terminal-294-1" in page.text
    app_css = client.get("/static/app.css")
    assert app_css.status_code == 200
