...
def test_pwa_manifest_service_worker_and_offline_shell(client):
    ...
    assert "atlaso-pwa-v171" in service_worker.text
    ...
    assert "/static/ui-patterns.js?v=atlaso-ui-foundation-20260726-3" in service_worker.text
...
def test_shared_ui_pattern_shell_and_wizard_contracts(client):
    ...
    for shell in (base, public_base):
        assert shell.index("/static/vendor/tabulator/tabulator.min.js") < shell.index(
            "/static/ui-patterns.js?v=atlaso-ui-foundation-20260726-3"
        )
        assert shell.index(
            "/static/ui-patterns.js?v=atlaso-ui-foundation-20260726-3"
...
def test_monitor_page_renders_and_data_endpoint(client):
    ...
    assert "/static/ui-patterns.js?v=atlaso-ui-foundation-20260726-3" in page.text
