...
def test_vault_javascript_uses_shared_grid_wizard_and_timed_eye():
    ...
    assert "network-boot-lifecycle-430-432-20260820-2" in base_template
...
def test_remote_vault_uri_launch_uses_one_use_server_side_ticket(client, monkeypatch):
    ...
    assert "/static/app.css?v=network-boot-lifecycle-430-432-20260820-2" in remote_page.text
