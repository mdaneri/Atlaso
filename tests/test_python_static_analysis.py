...
def test_static_analysis_configuration_is_pinned_and_scoped() -> None:
    ...
    assert project["tool"]["mypy"] == {
        ...
        "files": [
            ...
            "atlaso/app/services/kmip_log_capture.py",
            "atlaso/app/services/nginx_log_capture.py",
            "atlaso/app/services/nginx_log_sealing.py",
