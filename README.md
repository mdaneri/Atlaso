...
atomic replacement, removing stale library rows only for canonical missing VMX paths beneath its validated exact or
multi-root artifact scope; missing registration paths outside that scope remain fatal.
Hyper-V remains
