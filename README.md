...
- [OpenID Connect provider](docs/services/oidc-provider.md) — administer confidential clients, exact redirects, key
  rotation, explicit identity sources, and privacy-safe scoped claims.
